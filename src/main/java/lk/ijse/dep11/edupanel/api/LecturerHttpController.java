...
import lk.ijse.dep11.edupanel.to.responce.LecturerResTO;
    ...
    public LecturerResTO createNewLecturer(@ModelAttribute @Valid LecturerReqTO lecturer){
        try (Connection connection = pool.getConnection()) {
            ...
            try {
                ...
                stmInsertLecturer.setString(3, lecturer.getQualification());
                ...
                PreparedStatement stmInsertRank = connection
                        .prepareStatement("INSERT INTO "+ table +" (lecture_id, `rank`) VALUES (?, ?)");
